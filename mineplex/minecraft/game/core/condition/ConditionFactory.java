...
import mineplex.minecraft.game.core.condition.conditions.Vulnerability;
...
public class ConditionFactory
{
  ...
  {
    return this.Manager.AddCondition(new mineplex.minecraft.game.core.condition.conditions.Cloak(this.Manager, reason, ent, source, 
  ...
  public Condition Vulnerable(String reason, LivingEntity ent, LivingEntity source, double duration, int mult, boolean extend, boolean showIndicator, boolean ambient)
  {
    return this.Manager.AddCondition(new Vulnerability(this.Manager, reason, ent, source, 
      Condition.ConditionType.WITHER, mult, (int)(20.0D * duration), extend, 
