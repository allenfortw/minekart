...
public class ConditionEffect implements org.bukkit.event.Listener
{
  ...
  public void Cloak(UpdateEvent event)
  {
    ...
    for (LivingEntity ent : this.Manager.GetIndicators().keySet())
    {
  ...
  public void Shock(UpdateEvent event)
  {
    ...
    for (Iterator localIterator1 = this.Manager.GetIndicators().keySet().iterator(); localIterator1.hasNext(); 
        localIterator2.hasNext())
    {
      LivingEntity ent = (LivingEntity)localIterator1.next();
      localIterator2 = ((LinkedList)this.Manager.GetIndicators().get(ent)).iterator(); continue;ConditionIndicator ind = (ConditionIndicator)localIterator2.next();
