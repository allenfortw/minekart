  ...
  public void AddPunishment(final String playerName, Category category, final String reason, final Player caller, int severity, boolean ban, long duration)
  {
    ...
    this._repository.Punish(new Callback()
    {
      public void run(String result)
      {
        ...
        {
          String durationString = F.time(UtilTime.convertString(finalDuration < 0L ? -1L : finalDuration * 3600000L, 1, UtilTime.TimeUnit.FIT));
          ...
          if (reason == PunishmentSentence.Ban)
          {
            ...
            UtilPlayer.kick(UtilPlayer.searchOnline(null, playerName, false), Punish.this.GetName(), caller.getName() + " banned you because of " + F.elem(this.val$reason) + " for " + 
              durationString + ".");
