...
public class PetPage extends ShopPageBase<PetManager, PetShop>
{
  ...
  public void renamePet(Player player, Pet pet, boolean petPurchase)
  {
    ...
    entityPlayer.playerConnection.sendPacket(new net.minecraft.server.v1_6_R3.Packet103SetSlot(containerCounter, 0, new net.minecraft.server.v1_6_R3.ItemStack(net.minecraft.server.v1_6_R3.Item.NAME_TAG)));
