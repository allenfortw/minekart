...
public class PetTagPage extends ShopPageBase<PetManager, PetShop>
{
  ...
  {
    this.inventory.setItem(0, new net.minecraft.server.v1_6_R3.ItemStack(Item.NAME_TAG));
  ...
  public void SelectTag()
  {
    ...
    PetExtra tag = new PetExtra("Rename " + this._pet.GetName() + " to " + this._tagName, org.bukkit.Material.NAME_TAG, 1000);
