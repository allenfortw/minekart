...
public class FakeItemDrop
  extends FakeEntity
{
  private net.minecraft.server.v1_6_R3.ItemStack _itemStack;
  ...
  protected void UpdateDataWatcher(DataWatcher dataWatcher)
  {
    ...
    dataWatcher.a(10, new net.minecraft.server.v1_6_R3.ItemStack(this._itemStack.getItem(), this._itemStack.count));
  }
