...
public abstract class DisguiseBase
{
  ...
  {
    UpdateDataWatcher();
    return new Packet40EntityMetadata(this.Entity.id, this.DataWatcher, true);
  }
  ...
  public void UpdateEntity(net.minecraft.server.v1_6_R3.Entity entity)
  {
    this.Entity = entity;
  }
  
  public net.minecraft.server.v1_6_R3.Entity GetEntity()
  {
    return this.Entity;
  }
