...
public abstract class DisguiseInsentient extends DisguiseLiving
{
  ...
  public List<net.minecraft.server.v1_6_R3.Packet> getArmorPackets()
  {
    List<Packet5EntityEquipment> p5 = new ArrayList();
    ...
    for (short i = 0; i < armorContents.length; i = (short)(i + 1))
    {
      ...
      if (armorSlot != null)
      {
        p5.add(new Packet5EntityEquipment(this.Entity.id, i, armorSlot));
      }
    }
