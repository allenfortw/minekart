  ...
  private void UpdateNpcLocations()
  {
    for (NpcEntry npc : this._npcs.values())
    {
      if (npc.Entity != null)
      {
        ...
        if ((IsNpcChunkLoaded(npc.Entity)) && ((npc.Entity instanceof org.bukkit.craftbukkit.v1_6_R3.entity.CraftCreature)))
        {
  ...
  public void LoadNpcs()
  {
    ...
    try
    {
      ...
      if (npcFile.exists())
      {
        ...
        br = new BufferedReader(new java.io.InputStreamReader(fstream));
