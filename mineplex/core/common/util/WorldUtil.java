...
public class WorldUtil
{
  public static World LoadWorld(WorldCreator creator)
  {
    ...
    net.minecraft.server.v1_6_R3.WorldType type = net.minecraft.server.v1_6_R3.WorldType.getType(creator.type().getName());
    ...
    if (converter.isConvertable(name))
    {
      ...
      converter.convert(name, new net.minecraft.server.v1_6_R3.ConvertProgressUpdater(server.getServer()));
    }
