...
public class MapUtil
{
  ...
  public static void ResendChunksForNearbyPlayers(Collection<net.minecraft.server.v1_6_R3.Chunk> chunks) { int j;
    int i;
    for (Iterator localIterator = chunks.iterator(); localIterator.hasNext(); 
        ...
        i < j)
    {
      net.minecraft.server.v1_6_R3.Chunk c = (net.minecraft.server.v1_6_R3.Chunk)localIterator.next();
  ...
  public static net.minecraft.server.v1_6_R3.Chunk ChunkBlockChange(org.bukkit.World world, int x, int y, int z, int id, byte data)
  {
    ...
    if ((l1 != 0) && (!c.world.isStatic)) {
      net.minecraft.server.v1_6_R3.Block.byId[l1].l(c.world, j2, y, k2, i2);
    }
  ...
  {
    ((CraftPlayer)player).getHandle().chunkCoordIntPairQueue.add(new net.minecraft.server.v1_6_R3.ChunkCoordIntPair(x, z));
  }
  ...
  {
    ((CraftPlayer)player).getHandle().playerConnection.sendPacket(new net.minecraft.server.v1_6_R3.Packet52MultiBlockChange(x, z, dirtyBlocks, dirtyCount, ((CraftWorld)world).getHandle()));
  }
  ...
  public static void UnloadWorld(JavaPlugin plugin, org.bukkit.World world)
  {
    ...
    {
      net.minecraft.server.v1_6_R3.Chunk chunk = (net.minecraft.server.v1_6_R3.Chunk)chunkIterator.next();
